...
export function announceDropdownOpen(sourceId: string, currentDetails?: HTMLDetailsElement | null) {
	document
	...
	document.dispatchEvent(new CustomEvent<string>(DROPDOWN_OPEN_EVENT, { detail: sourceId }));
}
